...
import org.rj.auth_service.domain.user.dto.*;
import org.rj.auth_service.domain.user.model.UserDetails;
import org.rj.auth_service.domain.user.ports.in.*;
...
public class UserAuthResource {
    ...
    public ResponseEntity<UserIdResponse> register(@RequestBody @Valid RegisterUserRequest registerUserDto) {
    ...
    public ResponseEntity<Void> modify(@PathVariable("id") String userId,
        ...
        modifyUserUserCase.modify(email, userId, userModifyRequest);
        return ResponseEntity.ok().build();
    }
