...
import org.rj.application_service.application.rest.dto.AddJobApplicationRequest;
import org.rj.application_service.application.rest.dto.ModifyJobApplicationRequest;
...
public class ApplicationJobResource {
    ...
    @GetMapping
    public ResponseEntity<UserJobApplications> getJobs(@RequestHeader("X-User-Id") Long userId,
                                                       @RequestParam(value = "page") Long page,
                                                       @RequestParam(value = "pageSize", defaultValue = "10") Long pageSize) {
        UserJobApplications jobs = getApplicationJobs.getJobs(new GetAllUsersJobsCommand(page,pageSize,new UserProfileId(userId)));
